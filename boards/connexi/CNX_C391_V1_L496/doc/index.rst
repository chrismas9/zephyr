.. _CNX_C391_V1_L496_board:

Connexi CNX-C391-V1x.with STM32L496
###################################

Overview
********

The Connexi CNX-C391-V1x is a DIP40 module

.. image:: img/CNX_C391_V1.jpg
     :align: center
     :CNX-DIP40-L496

More information about the board can be found at the Connexi website.
...
The default configuration can be found in the defconfig file:
	...
	:zephyr_file:`boards/st/CNX_C391_V1_L496/CNX_C391_V1_L496_defconfig`
...
Applications for the ``CNX_C391_V1_L496`` board configuration can be built and
